...
const Home = () => {
    return ( 
        <div class="p-12 mx-auto lg:px-8">
<div class="relative px-4 sm:px-8 lg:px-12">
<div class="mx-auto max-w-2xl lg:max-w-5xl">
<div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-[auto_1fr]">
<div class="lg:pl-20">
<div class="px-2.5 w-full flex">
    <img src={me} alt="pb" className='mb-12 lg:mx-0 m-auto aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800 max-w-xs'/>
</div>
</div>
<div class="lg:order-first lg:row-span-2">
<h1 class="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">I’m Mario Seiler. I live in Bern, where I work as a software engineer.</h1>
...
<a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="mailto:mario.seiler@outlook.com">
<svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
